...
"""
    ...
    StateMachine:
        description: automat finit care este folosit in verificarea anumitor secvente
        startState: List<String> (stari_initiale)
        finishStates: List<String> (stari_finale)
        states: Set<String> (multimea_starilor)
        
    State:
        description: starea intr-un anumit moment - string
        transitions: Dictionary<String, Tuple<String, String>> (graf)
